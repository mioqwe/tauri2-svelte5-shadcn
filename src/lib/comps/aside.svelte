...
<div class="flex flex-col gap-1 h-full w-[30%] border-r border-neutral-700 p-2">
  <div class="flex flex-row gap-1">
    <a class="p-2 rounded-md border border-neutral-700">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-terminal-plus" viewBox="0 0 16 16">
  ...
  <button class="text-left border border-neutral-700 p-2 rounded-md">
    <div class="flex flex-col">
      <p>Note</p>
      <p class="text-neutral-300 text-xs">first works in this note</p>
    </div>
  </button>
</div>
